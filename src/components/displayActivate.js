...
class Slider extends Component {
  ...
  render() {
    ...
    return (
      <div className="slider" ref={(el) => this.el = el} style={{
        height: 32,
        width: 48,
        borderRadius: 8,
        ...
        left: holdPosition,
        position: "absolute",
      }} onMouseDown={this.handleDown} onTouchStart={this.handleDown}>
        {">"}
      </div>
    );
  }
...
class DisplayActivate extends Component {
  state = {
  ...
  render() {
    ...
    return(
      <div style={{
        ...
        <div ref={(el) => this.arrowHolder = el} style={{
          height: 32,
          lineHeight: "32px",
          width: "calc(100% - 32px)",
          maxWidth: "400px",
          ...
          <Slider triggerXPosition={triggerXPosition} onReachedTriggerPosition={onSlide} />
          Activate Infinity Stones
        </div>
      </div>
    );
  }
...
export default DisplayActivate;
